...
class TestDeliverGoods:
    ...
    def test_error_user_id(self):
        code = self.seller.deliver_goods(self.buyer_id+'_x', self.store_id, self.order_id)
        assert code != 200
    ...
    def test_error_order_id(self):
        code = self.seller.deliver_goods(self.buyer_id, self.store_id, self.order_id+'_x')
        assert code != 200
